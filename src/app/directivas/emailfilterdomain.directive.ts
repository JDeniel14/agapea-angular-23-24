 ...
 */
@Directive({
  //<---- decorador que da informacion para que interprete que es una directiva
  ...
  providers: [
    ...
    //inyectable en servicios de validacion
    {
      ...
      useExisting: EmailfilterdomainDirective,
      multi: true,
...
export class EmailfilterdomainDirective implements Validator {
  ...
  validate(control: AbstractControl<any, any>): ValidationErrors | null {
    ...
    if (control.value && (control.value as string).indexOf('@')) {
      //hay que buscar el @ con indexof, no hay contains, devuelve undefined o la posicion
